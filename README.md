...
# CNNbaseline + QAT— Cómo ejecutarlo

Entrena la misma CNN baseline pero esta vez implementando Quantization Aware training

## 1. Preparación
Se usa la misma preparaión que en CNN Baseline con augmentation
...
```python
DATA_DIR = r'C:\Users\perec\...\deep-final-alpha\Data'
```
...
```
CNNbaseline + augmentation/
├── train_BaselineCNN_QAT_dividit.ipynb          # 1. entrenar
├── evaluate_QAT_adaptat.ipynb                   # 2. evaluar
```
